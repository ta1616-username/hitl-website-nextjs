...
export function Tagline({ size = 44, color = '#ffffff', opacity = 1 }) {
  return (
    <span style={{
      fontFamily: '"Playfair Display", "EB Garamond", Georgia, serif', fontSize: size, lineHeight: 1.1, color, opacity,
      whiteSpace: 'nowrap', letterSpacing: '-0.01em', fontStyle: 'italic', fontWeight: 600,
    }}>
